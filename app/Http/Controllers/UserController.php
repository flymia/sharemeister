...
class UserController extends Controller
{
    ...
    public function downloadSxcu(Request $request)
    {
        ...
        if (!$token) {
            return back()->with('error', 'Please generate an API key first.');
        }

        $token = session('apikey') ?? 'DEIN_API_KEY_HIER';
...
BASH
    // Wir müssen die URL und den App-Namen hier konkatenieren, 
    // da Nowdoc keine Variablen-Interpolation erlaubt.
    . "\nENDPOINT=\"{$url}\"\n" .
    <<<'BASH'
